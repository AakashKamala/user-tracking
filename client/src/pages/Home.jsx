...
const home = () => {
  return (
    <div>
        <h1>A cybersecurity platform</h1>
        <p>with all the advancements in tech, cybersecurity has become a critical field.</p>
        <p>people need to know every way they can be tracked on the internet</p>
